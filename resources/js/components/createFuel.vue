<template>
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <button class="btn text-white" style="background-color: #FD5631; margin-top: 1em" @click="createFuel">Submit</button>
            </div>
        </div>
    </div>
</template>
